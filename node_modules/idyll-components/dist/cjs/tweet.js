...
var Tweet = function (_Component) {
  ...
  function Tweet(props) {
    ...
    _this.tweetContainer = (0, _react.createRef)();
  ...
  Tweet.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      'div',
      {
        ...
        style: this.props.style ? this.props.style : { minHeight: 309, marginTop: 10, marginBottom: 10 }
      },
...
Tweet.propTypes = {
  id: _propTypes2.default.string, //Tweet id can be found via url, e.g https://twitter.com/user/status/id
  parameters: _propTypes2.default.object //https://developer.twitter.com/en/docs/twitter-for-websites/embedded-tweets/guides/embedded-tweet-parameter-reference
};
