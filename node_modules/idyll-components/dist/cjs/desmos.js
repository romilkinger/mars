...
var Desmos = function (_React$Component) {
  ...
  Desmos.prototype.render = function render() {
    var _props = this.props,
        ...
        id = _props.id,
        style = _props.style,
        attributeProps = _objectWithoutProperties(_props, ['idyll', 'hasError', 'updateProps', 'apiKey', 'equation', 'height', 'width', 'id', 'style']);

    return _react2.default.createElement('div', _extends({
      id: this.state.id,
      style: _extends({}, style, { height: height, width: width })
    }, attributeProps));
  };
  ...
  Desmos.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
