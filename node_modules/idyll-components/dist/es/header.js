  ...
  return React.createElement(
    ...
    authors.map(function (author, i) {
      ...
      return React.createElement(
        'span',
        { key: authorDisplay },
        typeof author.link === 'string' ? React.createElement(AuthorLink, _extends({}, author, { color: color })) : authorDisplay,
...
var Header = function (_React$PureComponent) {
  ...
  Header.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      !!this.props.authors && React.createElement(ByLineMultipleAuthors, {
